package com.security.java_project.system_design.questions.bookMyShow.booking;
...
public class MovieController {
   ...
   public MovieController() {
    ...
    public void addMovie(Movie movie, City city) {
        allMovies.add(movie);
        List<Movie> movieInCity=cityVsMovies.getOrDefault(city,new ArrayList<>());
        movieInCity.add(movie);
        cityVsMovies.put(city,movieInCity);
    }
    ...
    public void updateMovieById(int movieId, Movie movie) {
        for (Movie movieObj : allMovies) {
            if (movieObj.getMovieId() == movieId) {
                movieObj.setMovieName(movieObj.getMovieName());
                movieObj.setMovieDuration(movieObj.getMovieDuration());
